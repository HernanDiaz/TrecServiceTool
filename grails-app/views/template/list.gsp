...
<body>
  ...
  <section id="list-template" class="first" style="margin-top:10px;">
    <g:form action="list" id="fixedSearchForm">
      <label for="fixpart">Fixed part</label>
      <g:textField name="fixpart" id="fixpart" value="${params.fixpart}"/>
