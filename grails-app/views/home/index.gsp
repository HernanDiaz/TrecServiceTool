...
<body>
	...
	<section id="intro" class="first">
                  ...
                  <h1 >
                       <img class="logo" src="${resource(dir:'images', file:'Pip-boy.png')}" alt="${meta(name:'app.name')}" width="80"  height="80" style="float: left; margin-right: 10px "/> 
                  <sec:ifNotLoggedIn>Guest</sec:ifNotLoggedIn>
                  <sec:ifLoggedIn>
                     <sec:loggedInUserInfo field="username"/>
                  </sec:ifLoggedIn>
                  , you are welcome to Trec Service Tool with Bootstrap 3.0.3 for Grails 2.3</h1>
	...
	<section id="info">
		<div class="row">
	    	<div class="col-md-4">
				...
				<p>Trec Service Tool uses <a href ="http://twitter.github.com/bootstrap/">Bootstrap</a> to render the web pages. 
	    	...
	    	<div class="col-md-4">
				...
				<p>Trec Service Tool is tested and supported in major modern browsers like Chrome 14, Safari 5+, Opera 11, Internet Explorer 7, and Firefox 5.</p>
			</div>
	    	<div class="col-md-4">
		    	<div class="center">
				...
				<p>Trec Service Tool is based on elements of HTML 5, CSS 3, Javascript 1.8, and jQuery 1.7 with progressively enhanced 
	...
	<section id="info2">
		<div class="row">
	    	<div class="col-md-4">
				...
				<p>Trec Service Tool uses the <a href ="https://github.com/eternicode/bootstrap-datepicker">Datepicker for Bootstrap</a> by Stefan Petre and Andrew Rowls</p>
			</div>
	    	<div class="col-md-4">
		    	<div class="center">
				...
				<p>Trec Service Tool contains a language selector that uses the <a href="http://www.famfamfam.com/lab/icons/flags/">FamFamFam flag icons</a> by Mark James.
	    	...
	    	<div class="col-md-4">
				...
				<p>Trec Service Tool contains several pages as starting points for the average website such as an About Page, Contact Page, 404, etc.</p>
			</div>
	    </div>
	</section>
