...
class gsp_trecServiceTool_useredit_gsp extends GroovyPage {
...
createTagBody(2, {->
printHtmlPart(5)
invokeTag('renderErrors','g',17,['bean':(userInstance),'as':("list")],-1)
printHtmlPart(6)
})
...
createTagBody(2, {->
printHtmlPart(8)
invokeTag('hiddenField','g',22,['name':("id"),'value':(userInstance?.id)],-1)
printHtmlPart(8)
invokeTag('hiddenField','g',23,['name':("version"),'value':(userInstance?.version)],-1)
printHtmlPart(8)
