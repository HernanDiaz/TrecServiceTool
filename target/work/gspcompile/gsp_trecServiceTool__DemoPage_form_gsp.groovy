...
class gsp_trecServiceTool__DemoPage_form_gsp extends GroovyPage {
...
printHtmlPart(7)
invokeTag('message','g',20,['code':("_DemoPage.myBoolean.label"),'default':("My Boolean")],-1)
printHtmlPart(2)
...
printHtmlPart(2)
invokeTag('field','g',92,['class':("form-control"),'type':("number"),'name':("myInteger"),'value':(_DemoPageInstance.myInteger)],-1)
printHtmlPart(3)
expressionOut.print(hasErrors(bean: _DemoPageInstance, field: 'myInteger', 'error'))
printHtmlPart(4)
