...
class gsp_trecServiceTool_layoutskickstart_gsp extends GroovyPage {
...
printHtmlPart(13)
invokeTag('render','g',33,['template':("/layouts/header")],-1)
printHtmlPart(14)
}
printHtmlPart(8)
...
printHtmlPart(16)
invokeTag('pageProperty','g',40,['name':("page.footer")],-1)
printHtmlPart(2)
}
else {
printHtmlPart(13)
...
printHtmlPart(12)
invokeTag('pageProperty','g',51,['name':("page.include.bottom")],-1)
printHtmlPart(2)
}
else {
printHtmlPart(18)
...
printHtmlPart(19)
invokeTag('layoutResources','r',58,[:],-1)
printHtmlPart(20)
})
